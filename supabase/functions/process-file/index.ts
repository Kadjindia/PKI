...
// Extraction de la logique métier pour réduire la complexité cognitive de Deno.serve
async function handleJsonPayload(req: Request, supabase: any) {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (contentType.includes("application/json")) {
      return await handleJsonPayload(req, supabase);
    }
